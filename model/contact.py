class Contact:
    ...
    def __init__(self, first_name="", middle_name="", last_name="", nickname="",
                 photo_path=r"", title="", company="", address="", telephone_home="", telephone_mobile="",
                 telephone_work="", telephone_fax="", email="", email2="", email3="", homepage="", birthday_day="",
                 birthday_month="-", birthday_year="", anniversary_day="", anniversary_month="-", anniversary_year="",
                 group="[none]", secondary_address="", secondary_telephone_home="",
                 secondary_notes=""):
